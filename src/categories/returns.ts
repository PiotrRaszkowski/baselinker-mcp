...
export const returnsCategory: CategoryDef = {
  ...
  methods: [
    ...
    },
    {
      ...
      schema: z
        .object({
          ...
          status_id: z
            .number()
            .describe("Return status (retrieve via getOrderReturnStatusList)"),
          custom_source_id: z
            .number()
            .optional()
            .describe("Custom order source identifier"),
          reference_number: z
            .string()
            .optional()
            .describe("External source reference number"),
          ...
          admin_comments: z
            .string()
            .optional()
            .describe("Seller notes (up to 200 chars)"),
          ...
          delivery_fullname: z
            .string()
            .optional()
            .describe("Recipient name and surname"),
          delivery_company: z.string().optional().describe("Recipient company"),
          delivery_address: z
            .string()
            .optional()
            .describe("Street and building number"),
          ...
          refund_account_number: z
            .string()
            .optional()
            .describe("Bank account for refund"),
      ...
      schema: z
        .object({
          ...
          delivery_fullname: z
            .string()
            .optional()
            .describe("Delivery address - name and surname"),
          delivery_company: z
            .string()
            .optional()
            .describe("Delivery address - company"),
          delivery_address: z
            .string()
            .optional()
            .describe("Delivery address - street and number"),
          delivery_postcode: z
            .string()
            .optional()
            .describe("Delivery address - postcode"),
          delivery_city: z.string().optional().describe("Delivery address - city"),
          delivery_state: z
            .string()
            .optional()
            .describe("Delivery address - state/province"),
          delivery_country_code: z
            .string()
            .optional()
            .describe("Two-letter country code"),
      ...
      schema: z
        .object({
          ...
          storage_id: z
            .string()
            .optional()
            .describe("Identifier of the storage source"),
          product_id: z
            .string()
            .optional()
            .describe("Product identifier in storage"),
          ...
          warehouse_id: z
            .number()
            .optional()
            .describe("Source warehouse identifier"),
          attributes: z
            .string()
            .optional()
            .describe('Product attributes (e.g. "Colour: blue")'),
          price_brutto: z.number().optional().describe("Single item gross price"),
          tax_rate: z
            .number()
            .optional()
            .describe("VAT rate (0-100, or special values)"),
          quantity: z.number().optional().describe("Number of pieces"),
          weight: z.number().optional().describe("Single piece weight"),
          status_id: z
            .number()
            .optional()
            .describe("Return item status identifier"),
          return_reason_id: z
            .number()
            .optional()
            .describe("Return reason identifier"),
        })
        .passthrough(),
    },
    {
      ...
      description:
        "Permanently delete a specific product item from an order return.",
      mode: "write",
      schema: z
        .object({
          return_id: z.number().describe("Order return identifier"),
    ...
    },
    {
      ...
      schema: z
        .object({
          ...
          order_return_product_id: z
            .number()
            .describe("Order return item ID from BaseLinker"),
          storage: z
            .string()
            .optional()
          ...
          warehouse_id: z
            .number()
            .optional()
            .describe("Product source warehouse identifier"),
          attributes: z
            .string()
            .optional()
          ...
          status_id: z
            .number()
            .optional()
            .describe("Product return status identifier"),
          return_reason_id: z
            .number()
            .optional()
            .describe("Return reason identifier"),
    ...
    },
    {
      ...
      schema: z
        .object({
          ...
          name: z
            .string()
            .describe("Status name (basic) displayed in the panel"),
          name_for_customer: z
            .string()
            .optional()
            .describe(
          ...
          color: z
            .string()
            .optional()
            .describe('Status color in hex format (e.g. "#FF0000")'),
          group_id: z
            .number()
            .optional()
    ...
    },
    {
      ...
      schema: z
        .object({
          ...
          target_status_id: z
            .number()
            .describe("ID of the replacement status for migrating returns; must differ from status_id"),
        })
        .passthrough(),
    },
    {
      ...
      schema: z
        .object({
          group_id: z
            .number()
            .describe("Identifier of the status group to be removed"),
        })
        .passthrough(),
    },
    {
    ...
    },
    {
      ...
      schema: z
        .object({
          return_id: z
            .number()
            .describe("Identifier of the order return being refunded"),
          order_refund_done: z
            .number()
            .describe(
          ...
          refund_date: z
            .number()
            .describe("When the refund occurred (Unix timestamp)"),
          refund_comment: z
            .string()
    ...
    },
    {
      ...
      description:
        "Run a personal automatic-action macro trigger on an order return.",
      mode: "write",
      schema: z
        .object({
          return_id: z
